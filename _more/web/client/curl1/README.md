...
```
user@DESKTOP-96FRN6B MINGW64 /d/ccc/ccc109a/se/rust/_more/web/client/curl1 (master)
$ cargo run
    Updating crates.io index
  Downloaded curl v0.4.30
  Downloaded schannel v0.1.19
  Downloaded curl-sys v0.4.32+curl-7.70.0
  ...
  Downloaded libz-sys v1.0.25
   ...
   Compiling curl1 v0.1.0 (D:\ccc\ccc109a\se\rust\_more\web\client\curl1)
    Finished dev [unoptimized + debuginfo] target(s) in 4m 09s
     Running `target\debug\curl1.exe`
<!doctype html>
<html lang="en-US">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/static/styles/app_3435740262440257562.css"/>
  ...
  <div class="flex flex-column flex-row-l">
    ...
    <div class="w-20-l flex-column pl0-l pr0-l pl3 pr3">
      ...
      <p class="tc f3 f2-l mt3">
        <a href="https://blog.rust-lang.org/2020/06/18/Rust.1.44.1.html" class="download-link">Version 1.44.1</a>
      </p>
    </div>
  </div>
</header>
...
corporations, from embedded devices to scalable web services, Rust is a great fit.</strong>
    ...
    <div class="testimonials">
      ...
      <div class="testimonial flex-none flex-l">
        <div class="w-100 w-30-l tc">
          <a href="https://www.youtube.com/watch?v=u6ZbF4apABk"><img src="/static/images/user-logos/yelp.png" 
alt="Yelp Logo" class="w-80" /></a>
        </div>
        <div class="w-100 w-70-l" id="yelp-testimonial">
          <blockquote>
            All the documentation, the tooling, the community is great - you have all the tools to succeed in 
writing Rust code.
          </blockquote>
...
<section class="white thanks">
  <div class="w-100 mw-none ph3 mw8-m mw9-l center">
    ...
    <div class="description">
      <p class="lh-copy f2">
        Rust would not exist without the generous contributions of time, work, and resources from individuals 
and companies. We are very grateful for the support!
      </p>
    </div>
    <div class="flex flex-column flex-row-l">
      ...
      <div id="company-sponsorships" class="mw-50-l pt3 pt0-l flex flex-column justify-between-l">
        ...
        <p class="flex-grow-1">The Rust project receives support from companies through the donation of infrastructure.</p>
